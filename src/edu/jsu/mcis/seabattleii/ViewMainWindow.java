...
public class ViewMainWindow extends JFrame implements AbstractView {
    ...
    public void modelPropertyChange(final PropertyChangeEvent e) {
        ...
        //CHECK TO SEE IF THERE IS A WINNER
             if(e.getPropertyName().equals(DefaultController.PLAYER1_FLEET_DEPLETED)){
                JOptionPane.showMessageDialog(this, "Player 2 Wins!");
            }
            else if(e.getPropertyName().equals(DefaultController.PLAYER2_FLEET_DEPLETED)){
                JOptionPane.showMessageDialog(this, "Player 1 Wins!");
            }
            
             if(e.getPropertyName().equals(DefaultController.PLAYER2_FLEET_DEPLETED) || e.getPropertyName().equals(DefaultController.PLAYER1_FLEET_DEPLETED)){
                 System.exit(0);
             }
             
         //CHECK FOR HITTING A SQUARE THAT WAS ALREADY HIT
         if(e.getPropertyName().equals(DefaultController.OCCUPIED_SQUARE_SHOT)){
             JOptionPane.showMessageDialog(this, "You've Already Shot Here!  \n Please Chose A Square That You Haven't Shot At Already.");
         }
    }
