...
public class DefaultController extends AbstractController
{
    ...
    public static final String PLAYER1_FLEET_DEPLETED = "Player1FleetDepleted";
    public static final String PLAYER2_FLEET_DEPLETED = "Player2FleetDepleted";
    
    public static final String OCCUPIED_SQUARE_SHOT = "OccupiedSquareShot";
    /* 
